...
export const AuthScreen = ({ onLogin, onRegister, initialView = "login" }: AuthScreenProps) => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent/10 rounded-full blur-[120px] animate-float"
      ...
      <div
        className="absolute bottom-20 right-20 text-accent/20 animate-float"
        style={{ animationDelay: "-2s" }}
      >
        <Terminal size={48} />
      </div>
      <div
        className="absolute top-1/3 right-1/4 text-primary/20 animate-float"
